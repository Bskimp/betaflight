...
typedef enum {
    ...
    // Always-on wing-tuning groups (see flight/wing_tune.h).
    FLIGHT_LOG_FIELD_CONDITION_WING_TUNE_SPA,
    FLIGHT_LOG_FIELD_CONDITION_WING_TUNE_SETPOINT,
    FLIGHT_LOG_FIELD_CONDITION_WING_TUNE_STERM,
    FLIGHT_LOG_FIELD_CONDITION_WING_TUNE_TPA,
    FLIGHT_LOG_FIELD_CONDITION_WING_TUNE_LAUNCH,
#endif
...
#ifdef USE_WING
    FLIGHT_LOG_FIELD_SELECT_WING_TUNE_SPA,
    FLIGHT_LOG_FIELD_SELECT_WING_TUNE_SETPOINT,
    FLIGHT_LOG_FIELD_SELECT_WING_TUNE_STERM,
    FLIGHT_LOG_FIELD_SELECT_WING_TUNE_TPA,
    FLIGHT_LOG_FIELD_SELECT_WING_TUNE_LAUNCH,
#endif
