...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_WING_LAUNCH_CLIMB_TIME,   VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 1000, 10000 }, PG_PID_PROFILE, offsetof(pidProfile_t, wing_launch_climb_time) },
